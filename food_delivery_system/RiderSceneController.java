 ...
 * @author USER
 */
public class RiderSceneController implements Initializable {
    ...
    @FXML
    private void Showorderdeatils(ActionEvent event) throws IOException {
             Parent root = FXMLLoader.load(getClass().getResource("RiderOderDetailscene.fxml"));
