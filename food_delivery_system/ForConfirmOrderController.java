 ...
 * @author User
 */
public class ForConfirmOrderController implements Initializable {
    ...
    private void NoButtonHandler(ActionEvent event) 
        throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("No.fxml"));
    ...
    private void GoButtonHandler(ActionEvent event) throws Exception {
